...
export default class HomeScreen extends Component {
  ...
  getMovie(){
    axios.get(this.state.ngrok_url+ "/movies")
    .then(()=>{
  ...
  likedMovie(){
    axios.get(this.state.ngrok_url+ "/like")
    .then(()=>{
     this.getMovie()
    })
    .catch((error)=>{
  ...
  dislikedMovie(){
    axios.get(this.state.ngrok_url+ "/dislike")
    .then(()=>{
     this.getMovie()
    })
    .catch((error)=>{
  ...
  notWatched(){
    axios.get(this.state.ngrok_url+ "/did_not_watch")
    .then(()=>{
     this.getMovie()
    })
    .catch((error)=>{
            ...
            <View style={styles.subContainer}>
              <View style={styles.posterContainer}>
                  ...
                  <Image
                    ...
                    source = {{uri: this.state.movieDetails.poster_link}}
                  />
              </View>
              ...
              <View style={styles.ratingContainer}>
                {/*Add the components to show rating of the movie below*/}
                 <Text style={styles.subtitle}>{this.state.movieDetails.release_date}</Text>
              </View>
              <View style={styles.iconButtonContainer}>
                ...
                <Image
                    style = {styles.iconImage}
                    source = {require("../assets/did_not_watch.png")}
                  />
                </TouchableOpacity>
